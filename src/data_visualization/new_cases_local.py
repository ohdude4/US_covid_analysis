...
if __name__ == '__main__':
    conf = SparkConf().setAppName("Line").setMaster("local[*]")
    ...
    fig_CumulativeConfirmed.write_html("plot_output/CumulativeConfirmed.html")
    fig_CumulativeDeaths.write_html("plot_output/CumulativeDeaths.html")
    fig_DailyNewConfirmed.write_html("plot_output/DailyNewConfirmed.html")
    fig_DailyNewDeaths.write_html("plot_output/DailyNewDeaths.html")
